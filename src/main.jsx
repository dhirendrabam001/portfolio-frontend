...
import SmpackingRoutes from "./Router/ProjectViewRoutes/SmpackingRoutes.jsx";
import HealthcareRoutes from "./Router/ProjectViewRoutes/HealthcareRoutes.jsx";
import EmployeeSystemRoutes from "./Router/ProjectViewRoutes/EmployeeSystemRoutes.jsx";
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          ...
          element={<HealthcareRoutes />}
        ></Route>
        <Route
          path="/employeesystem-details"
          element={<EmployeeSystemRoutes />}
        ></Route>
      </Routes>
    </BrowserRouter>
  </StrictMode>,
